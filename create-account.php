...
if ($_POST) {
    ...
    if ($newpassword == $cpassword) {
        ...
        if ($result->num_rows == 1) {
            $error = '<label for="promter" class="form-label" style="color:red;text-align:center;">Already have an account for this Email address.</label>';
        } else {
        ...
        $error = '<label for="promter" class="form-label" style="color:red;text-align:center;">Passwords do not match.</label>';
    }
}
?>
